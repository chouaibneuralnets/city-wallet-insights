...
export const IPhonePreview = ({
  ...
  return (
    <Card className="p-6 shadow-sm-elegant border-border/70 h-full flex flex-col bg-gradient-to-br from-card to-secondary/30 overflow-hidden">
      ...
      {/* Weather scenario picker */}
      <div className="grid grid-cols-4 gap-1.5 p-1 rounded-xl bg-secondary/60 mb-6">
        {(Object.keys(scenarios) as Weather[]).map((w) => {
          const s = scenarios[w];
          ...
          return (
            <button
              ...
              className={cn(
                ...
                active
                  ? "bg-card text-foreground shadow-sm-elegant"
