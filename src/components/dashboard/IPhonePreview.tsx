...
export const IPhonePreview = ({
  ...
  product?: string;
  tone?: Tone;
  /** Final message already generated by RuleBuilder */
  message?: string;
}) => {
  ...
  const productInfo = productMeta[product] ?? productMeta["Coffee"];
  ...
  const time = now.toLocaleTimeString("en-GB", { hour: "2-digit", minute: "2-digit", timeZone: "Europe/Berlin" });
    ...
    <Card className="p-6 shadow-sm-elegant border-border/70 h-full flex flex-col bg-gradient-to-br from-card to-secondary/30 overflow-hidden">
      <div className="flex items-start justify-between mb-4 gap-2">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Live preview of the AI offer on the customer screen</p>
        </div>
        {deployedText && (
      ...
      <div className="flex items-center justify-between p-2.5 rounded-xl bg-secondary/60 mb-6 border border-border/40">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[10px] text-muted-foreground">· live Stuttgart sensor</span>
        </div>
                ...
                <div className="relative">
                  ...
                  <div className="relative rounded-3xl bg-white/15 backdrop-blur-2xl border border-white/20 p-3 shadow-[0_20px_40px_-10px_rgba(0,0,0,0.5)]">
                    <div className="flex items-start gap-2.5">
                      {/* App icon — changes based on selected product */}
                      <div
                        className={cn(
      ...
      <div className="flex gap-2 mt-2">
        ...
        <Button className="flex-1 gap-2 bg-gradient-primary hover:opacity-90 transition-opacity">
          <Sparkles className="size-4" /> Activate offer
        </Button>
      </div>
    </Card>
  );
